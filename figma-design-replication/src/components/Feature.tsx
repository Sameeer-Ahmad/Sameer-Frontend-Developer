...
import "./Feature.css";
import glassImage from "../assets/video/glass.png";
import reactangle from "../assets/Rectangle.png";
import Ai from "../assets/Ai.png";
import marketInsight from "../assets/marketInsight.png";
const Features: React.FC = () => {
  return (
    <div className="flex flex-col item-center justify-center h-[832px] custom:sm-h-[1000px] mt-[70px] lg:mt-[100px] md:mt-[100px] sm:mt-[250px] custom-sm:mt-[250px] sm:h-[auto] ">
